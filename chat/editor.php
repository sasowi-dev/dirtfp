...
<!--</input>-->
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
              <input class="mdl-textfield__input" type="text" id="message" autocomplete="off" disabled>
              <label class="mdl-textfield__label" for="message">이번엔 안타깝지만, 읽는 것 만으로 안녕이라고 인사해 주세요.</label>
