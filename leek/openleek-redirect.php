...
오픈리크 봇이며, 리크봇의 오픈소스 염가판입니다.
  ...
  <div class="flex items-center flex-shrink-0 text-black mr-6">
      <!--웹페이지 기본 정보 -->
<a href="index.php"  class="logobox">오픈리크</a></div>
<style>
.index9{
...
<!--
    <div class='flex max-w-sm w-full bg-white shadow-md rounded-lg overflow-hidden mx-auto'>
        ...
        <div class='flex items-center px-2 py-3'>
            ...
            <div class='mx-3'>
                <p class='text-gray-600' id="metacon">오픈 리크</p>
            </div>
        </div>
    </div>
</div>-->
...
<br>
            ...
            <p class="text-gray-500 text-sm">본 링크는 <a href="#" class="text-indigo-600 hover:underline" id="whosebot">오픈리크봇</a>에 의해 생성되었습니다.</p>
    ...
    var botentity = getUrlParameter('be');
document.getElementById('goingurl').innerHTML = redomain;
document.getElementById('whosebot').innerHTML = botentity;
if(botentity == "undefined"){
alert("Bot Entity 설정을 완료해 주십시오.");
window.close();
}
else{
